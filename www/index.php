...
<!--END: Top Menu-->
      ...
      <blockquote>
        <p> This package accompanies the text <em>Introduction to Probability and Statistics Using R</em>  (in progress) by G. Andy Chang and G. Jay Kerns. The package contributes functions unique to the book as well as specific configuration and selected functionality to R Commander, the excellent pioneering work by John Fox of McMaster University.</p>
