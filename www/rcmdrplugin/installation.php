...
<head>
	...
	<title>RcmdrPlugin.IPSUR Installation</title>
	...
	<ol type="1">
		...
		<li>
         ...
         <br />
			...
			<ul>
				<li>
					<strong>Install from CRAN:</strong> This method works well with Windows and MacOS X 
					installations and ensures that you have the latest stable version of the package. 
               ...
               <br />
				...
				<li>
					<strong>Install from download:</strong> Downloads of the binary packages are available for Windows and MacOS X. 
					The packages, along with specific instructions for installing them on various platforms are available 
					on the <a href="downloads.php">downloads page</a>. 
				</li>
				<li>
					<strong>Install from package source:</strong> This method of installation is recommended for all 
					GNU-Linux operating systems and all other non-supported systems. To install the current 
					released version of the source, type the following at the command prompt "&gt;": 
                <div class="name" align="center">
                  ...
                  install.packages("RcmdrPlugin.IPSUR", repos = "http://www.cran.r-project.org", type="source")
					...
					<p>
						Instructions to install from a downloaded copy of the <span class="name">RcmdrPlugin.IPSUR</span> 
						source are available on the <a href="downloads.php">downloads page</a>.
					</p>
				</li>
			</ul>
		</li>
